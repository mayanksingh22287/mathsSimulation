...
def check(lines):
    ...
    operand_list=["var","add","sub","mov","ld","st","mul","div","rs","ls","xor","or","and","not","cmp","jmp","jlt","jgt","je","hlt","addf","subf","movf"]
    for i in range(0,len(lines)):
        word=lines[i].split()
        z=i+1
        #print(word)
        if(i>var_line_no and word[0]=="var"):
            ...
            bool=False
        elif(word[0]=="add" or word[0]=="sub" or word[0]=="mul" or word[0]=="xor" or word[0]=="or" or word[0]=="and" or word[0]=="addf" or word[0]=="subf" ):
            if(len(word)!=4):
                ...
                bool=False
        elif(word[0]=="mov" or word[0]=="ld" or word[0]=="st" or word[0]=="div" or word[0]=="rs" or word[0]=="ls" or word[0]=="not" or word[0]=="cmp"):
            if(len(word)!=3):
...
if(check(lines)):
    ...
    "jlt": "11100", "jgt": "11101", "je": "11111", "hlt": "11010","addf": "10000","subf":"10001","movf":"10010"}
    #registers opcodes
    ...
    for i in range(0,len(lines)): #taking range because we have to also keep in mind about the error in which line
        ...
        if(word!=[]):
            ...
            if(word[0]=="rs" or (word[0]=="mov" and word[2][0]=="$") or word[0]=="ls"):
                word[-1]=word[-1][1::]
